...
#define SUP_E LGUI_T(KC_E)
#define SHI_U LSFT_T(KC_U)

// Right-hand home row mods
#define SHI_H RSFT_T(KC_H)
#define SUP_T RGUI_T(KC_T)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		MT(MOD_LCTL, KC_ESC), KC_A, KC_O, SUP_E, SHI_U, KC_I, KC_D, SHI_H, SUP_T, KC_N, KC_S, KC_MINS, 
